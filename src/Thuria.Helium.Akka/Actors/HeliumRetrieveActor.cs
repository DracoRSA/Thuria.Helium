...
namespace Thuria.Helium.Akka.Actors
{
  ...
  public class HeliumRetrieveActor : HeliumActionActorBase
  {
    ...
    protected override void ReadyToPerformAction()
    {
      ...
      Receive<HeliumConstructSqlQueryResultMessage>(message => HandleSqlQueryResult(message));
      Receive<HeliumExecuteSqlQueryResultMessage>(message => HandleExecuteSqlQueryResult(message));
    }
